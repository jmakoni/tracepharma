# Tracing requests and FDA Form 3911
...
- [../exceptions/exceptions.md](../exceptions/exceptions.md) — investigation records
- [../exceptions/verifications.md](../exceptions/verifications.md) — VRS / verification history
- [quarantine.md](quarantine.md) — hold product under investigation
- [recall-and-inspection.md](recall-and-inspection.md) — broader recall/inspection tools
