...
- [../master-data/trading-partners.md](../master-data/trading-partners.md) — partner master records
- [../master-data/sites-and-devices.md](../master-data/sites-and-devices.md) — site ATP licenses
- [compliance-alerts.md](compliance-alerts.md) — ATP-related alerts
- [../integrations/partner-onboarding.md](../integrations/partner-onboarding.md) — partner invite kit
