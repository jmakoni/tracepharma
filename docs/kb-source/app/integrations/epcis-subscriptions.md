...
- [connections.md](connections.md) — underlying endpoints
- [integration-health.md](integration-health.md) — delivery health
- [../exceptions/inbound-epcis.md](../exceptions/inbound-epcis.md) — received documents
