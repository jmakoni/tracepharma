...
- [connections.md](../integrations/connections) — non-token connection auth
- [integration-health.md](../integrations/integration-health) — failure spikes after rotation
- [pms-and-wholesaler-packs.md](../integrations/pms-and-wholesaler-packs) — PMS / WMS checklists
- [partner-onboarding.md](../integrations/partner-onboarding) — share onboarding artifacts securely
