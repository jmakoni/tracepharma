...
- [pack.md](../workflows/pack) — may auto-commission parent SSCC
- [repack-transform.md](../workflows/repack-transform) — TransformationEvent with commissioning biz step (Prepackager)
- [decommission.md](../workflows/decommission) — inverse lifecycle action
