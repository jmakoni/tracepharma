...
- [pack.md](../workflows/pack) — SSCC aggregation (all packing profiles)
- [break-pack.md](../workflows/break-pack) — aggregation break/repack
- [commission.md](../workflows/commission) — standalone ObjectEvent commissioning
- [cbv-biz-steps.md](../cbv-biz-steps) — repack transform quirk documented
