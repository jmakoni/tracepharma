...
- [ ] Same returning document shape as [return.md](../workflows/return)
- [ ] Scorecard metrics updated (`SaleableReturnScorecardMetrics`)

## Related pages

- [return.md](../workflows/return) — non-VRS return path
- [verify-product.md](../workflows/verify-product) — dispense-time VRS (no returning EPCIS)
- [decommission.md](../workflows/decommission) — unsaleable destruction
