...
- [pharmacy-outbound.md](../workflows/pharmacy-outbound) — pharmacy profile alternative (not available on wholesaler demo)
- [pack.md](../workflows/pack) — ensure SSCC hierarchy before ship
- [asset-tracking.md](../workflows/asset-tracking) — post-ship trace
- [cbv-biz-steps.md](../cbv-biz-steps)
