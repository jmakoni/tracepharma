...
- [saleable-return.md](../workflows/saleable-return) — requires VRS pass before returning EPCIS
- [pharmacy-outbound.md](../workflows/pharmacy-outbound) — ship after verify at pharmacy
- [asset-tracking.md](../workflows/asset-tracking) — trace serial history
