...
- [saleable-return.md](../workflows/saleable-return) — VRS-gated saleable credit path
- [decommission.md](../workflows/decommission) — destroy/expired with decommissioning biz step
- [receiving.md](../workflows/receiving) — partner return may later appear as inbound receive
