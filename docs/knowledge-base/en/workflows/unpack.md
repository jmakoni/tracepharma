...
- [pack.md](../workflows/pack) — aggregate loose units into new SSCC
- [break-pack.md](../workflows/break-pack) — unpack + re-pack in one flow
- [receiving.md](../workflows/receiving) — receive may trigger inline unpack branch
