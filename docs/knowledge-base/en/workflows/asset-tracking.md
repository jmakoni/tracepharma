...
- [receiving.md](../workflows/receiving), [outbound-shipping.md](../workflows/outbound-shipping), [commission.md](../workflows/commission) — event sources
- [cbv-biz-steps.md](../cbv-biz-steps) — biz_step / disposition oracle
- [shell-and-site.md](../workflows/shell-and-site) — hub scan routes here for unknown context
