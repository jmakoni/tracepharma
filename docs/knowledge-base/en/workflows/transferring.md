...
- [receiving.md](../workflows/receiving) — transfer receive uses receive semantics
- [outbound-shipping.md](../workflows/outbound-shipping) — partner-facing ship (different profile)
- [asset-tracking.md](../workflows/asset-tracking) — verify in-transit custody

## Notes / known quirks

- Transfers do **not** invent a `transferring` biz_step; see [cbv-biz-steps.md](../cbv-biz-steps).
