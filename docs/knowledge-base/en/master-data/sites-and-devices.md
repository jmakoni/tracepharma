...
- [../compliance/atp-readiness.md](../compliance/atp-readiness) — site ATP licenses
- [../settings/labeling.md](../settings/labeling) — label printers and SSCC
- [../operations/on-hand-and-unpacked.md](../operations/on-hand-and-unpacked) — site inventory views
- [trading-partners.md](../master-data/trading-partners) — partner locations vs owned sites
