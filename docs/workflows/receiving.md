...
5. Optional: open [receiving-issues.md](receiving-issues.md) after completion to report shortage, overage, or damage.
...
- [unpack.md](unpack.md) — break hierarchy after receive
- [transferring.md](transferring.md) — inter-site transfer receive leg
- [receiving-issues.md](receiving-issues.md) — post-receive exceptions
- [asset-tracking.md](asset-tracking.md) — verify custody after receive
