...
- [return.md](return.md) — return to vendor (disposition `returned` via returning flow)
- [commission.md](commission.md) — inverse action
- [cbv-biz-steps.md](cbv-biz-steps.md) — disposition vs biz_step distinction
