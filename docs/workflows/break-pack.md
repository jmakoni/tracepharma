...
- [unpack.md](unpack.md) + [pack.md](pack.md) — two-step equivalent
- [outbound-shipping.md](outbound-shipping.md) — ship new pallet
- [commission.md](commission.md) — standalone commissioning if parent not auto-commissioned
