...
- [outbound-shipping.md](outbound-shipping.md) — full wholesaler ship (blocked for pharmacy profile inverse)
- [verify-product.md](verify-product.md) — dispense verify before patient handoff
- [return.md](return.md) — non-saleable returns
