...
@section('content')
    ...
    <section class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div class="max-w-3xl space-y-5 leading-relaxed text-tp-muted">
            ...
            <p>
                This page is intentionally honest. LSPedia wins on global regulation breadth and Exchange scale. TracePharma wins on operator UX, EPCIS 1.2 GA with 2.0 capture, query-as-2.0, and HTTPS subscriptions, profile-tuned SaaS, and lower TCO for SMB–mid-market manufacturers, wholesalers, 3PLs, and dispensers.
            </p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            ...
            <x-marketing.competitor-table
                ...
                :rows="[
                    ...
                    ['capability' => 'EPCIS 1.2 / 2.0 repository', 'them' => 'Yes', 'us' => '1.2 GA default outbound; 2.0 JSON-LD capture + query-as-2.0 + HTTPS subscriptions; read-only trace for pharmacy'],
        ...
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            ...
            <div class="mt-8 grid gap-4 md:grid-cols-2">
                ...
                <div class="tp-card p-6">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-tp-muted">LSPedia offers full DSCSA suite breadth. TracePharma emphasizes receive-to-ship operator UX, EPCIS 1.2 GA with 2.0 capture + query-as-2.0 + HTTPS subscriptions, and ACK monitoring at lower TCO.</p>
                ...
                <div class="tp-card p-6">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-tp-muted">LSPedia Pharmacy Pro and network visibility serve chains well. TracePharma fits independents needing wholesaler-grade EPCIS depth and POST /api/v1/dispense-check.</p>
