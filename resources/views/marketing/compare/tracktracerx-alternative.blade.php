@php
    $tracktracerxFaqs = [
        ...
        ['question' => 'When should a pharmacy network choose TracePharma over TrackTraceRx?', 'answer' => 'Consider TracePharma when you need EPCIS 2.0 investigation, structured exceptions, buying-group dashboards, or wholesaler-grade receiving—not just verify-only network enrollment.'],
...
@section('meta_description', 'Honest comparison of TracePharma vs TrackTraceRx for pharmacy DSCSA. Network onboarding scale vs EPCIS 2.0 depth and buying-group infrastructure.')
...
@section('content')
    ...
    <section class="border-y border-tp-border bg-tp-canvas">
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            ...
            <p class="mt-3 max-w-2xl text-sm text-tp-muted">Pharmacy network enrollment and verify workflows overlap. EPCIS 2.0 depth and buying-group infrastructure are where platforms diverge.</p>
            ...
            <x-marketing.competitor-table
                ...
                :rows="[
                    ...
                    ['capability' => 'Pharmacy workflows', 'them' => 'Strong — network rollout focus', 'us' => 'Pharmacy profile + PMS dispense-check APIs'],
    ...
    <section class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <div class="tp-card-accent border-tp-accent-500/30 p-8">
                ...
                <ul class="mt-5 space-y-3 text-sm leading-relaxed text-tp-muted">
                    <li class="flex gap-3"><span class="text-tp-teal-400">→</span> You need EPCIS 2.0 trace search and structured exception workflows—so serial history is one query, not a folder of PDFs</li>
