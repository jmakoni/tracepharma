@php
    $infinitrakFaqs = [
        ...
        ['question' => 'When should a pharmacy consider TracePharma instead?', 'answer' => 'Consider TracePharma when you need EPCIS 2.0 investigation, structured exception workflows, multi-site reporting, or buying-group infrastructure—not just dispense-time verification.'],
...
@section('meta_description', 'Honest comparison of TracePharma vs InfiniTrak for US DSCSA pharmacy compliance. Turnkey dispenser onboarding vs EPCIS 2.0 depth, wholesaler workflows, and buying-group scale.')

@section('content')
    <x-marketing.page-hero
        eyebrow="Compare"
        title="TracePharma as an InfiniTrak alternative"
        description="InfiniTrak is a strong turnkey choice for independent pharmacies with PMS partnerships and white-glove onboarding. TracePharma fits dispensers and networks who need wholesaler-grade EPCIS depth, EPCIS 2.0 investigation, and profile-tuned L4 workflows beyond verify-only."
    >
        <x-slot:breadcrumb>
    ...
    <section class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div class="max-w-3xl space-y-5 leading-relaxed text-tp-muted">
            ...
            <p>
                This page is intentionally honest. InfiniTrak wins on pharmacy market familiarity and turnkey onboarding. TracePharma wins on profile-gated EPCIS 2.0 (full repository for trading partners; read-only trace for dispensers), structured exceptions, buying-group dashboards, and a single L4 platform if you outgrow verify-only workflows.
            </p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            ...
            <x-marketing.competitor-table
                ...
                :rows="[
                    ...
                    ['capability' => 'PMS integrations', 'them' => 'Strong — RedSail and pharmacy ecosystem', 'us' => 'PioneerRx, BestRx, PrimeRx dispense-check APIs'],
                    ...
                    ['capability' => 'EPCIS 2.0 repository', 'them' => 'Limited public positioning', 'us' => 'Profile-gated — full CBV 2.0 repo (mfg/wholesale/3PL/prepack); read-only trace for pharmacy'],
    ...
    <section class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <div class="tp-card-accent border-tp-accent-500/30 p-8">
                ...
                <ul class="mt-5 space-y-3 text-sm leading-relaxed text-tp-muted">
                    <li class="flex gap-3"><span class="text-tp-teal-400">→</span> You need EPCIS 2.0 investigation tools and serial-level receiving audit trails—so inspectors see evidence, not email threads</li>
        ...
        <div class="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            ...
            <div class="mt-8 grid gap-4 md:grid-cols-2">
                <div class="tp-card p-6">
                    ...
                    <p class="mt-2 text-sm leading-relaxed text-tp-muted">Receiving, VRS verification, FDA 3911, and PMS dispense-check APIs for independent and small-chain pharmacies.</p>
