    ...
    <div class="flex flex-col gap-4">
            ...
            <div class="card-body gap-4">
                ...
                >
                    <div class="form-control w-full gap-1.5">
                        <label for="decommission-scan-input" class="label-text text-sm font-medium">
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body gap-4">
                ...
                @empty
                    <p class="text-sm opacity-70">Scan EPCs that are on hand at the selected site.</p>
                @endforelse

                <button
                    type="button"
                    class="btn btn-error min-h-14"
                    wire:click="mountAction('confirmDecommission')"
