    ...
    <div class="flex flex-col gap-4">
        ...
        >
            <div class="card-body gap-4">
                ...
                @if ($this->siteId !== null)
                    <div class="text-sm">
                        <span class="opacity-70">Site locked:</span>
                        <span class="font-semibold">{{ $this->lockedSiteName() ?? ('#'.$this->siteId) }}</span>
                    </div>
                @endif
                ...
                >
                    <div class="form-control w-full gap-1.5">
                        <label for="saleable-return-scan-input" class="label-text text-sm font-medium">
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body gap-4">
                ...
                @empty
                    <p class="text-sm opacity-70">Scan EPCs on hand at the selected site to author returning events.</p>
                @endforelse

                <button
                    type="button"
                    class="btn btn-primary min-h-14"
                    wire:click="mountAction('confirmReturn')"
