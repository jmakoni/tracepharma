...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->unique('directory_object_id', 'users_directory_object_id_unique');
            $table->index('user_principal_name', 'users_user_principal_name_index');
        });
    }
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->dropUnique('users_directory_object_id_unique');
            $table->dropIndex('users_user_principal_name_index');
            $table->dropColumn([
                'directory_object_id',
                'user_principal_name',
                'employee_id',
