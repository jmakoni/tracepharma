...
/**
 * Find or create a tenant wholesaler partner that mirrors an FDA wholesaler.
 */
final class EnsureWholesalerPartnerFromCatalog
{
    /**
    ...
    public function handle(int|FdaOrganization $organization): ?TradingPartner
    {
        ...
        if ($org === null) {
            Log::warning('No tenant wholesaler partner mirrored: the FDA organization no longer exists.', [
