...
class TenantProvisionedReceived extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return app(ComposeDatabaseMail::class)->shouldSend(MailTemplateCatalog::TenantProvisionedReceived)
            ? ['mail']
            : [];
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return app(ComposeDatabaseMail::class)->mailMessage(
            MailTemplateCatalog::TenantProvisionedReceived,
            $this->variables,
            $this->from(),
        );
    }
