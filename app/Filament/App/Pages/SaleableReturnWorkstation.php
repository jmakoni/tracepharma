...
class SaleableReturnWorkstation extends Page
{
    ...
    protected static ?string $title = 'Saleable return';

    protected static ?int $navigationSort = 19;

    protected static string|UnitEnum|null $navigationGroup = 'Operations';

    protected string $view = 'filament.app.pages.saleable-return-workstation';
    ...
    public function processScan(
        ...
        $vrsStatus = (string) ($vrs['verification']->status ?? '');
        if ($vrsStatus !== 'verified') {
            $this->flash('error', (string) ($vrs['body'] ?: 'VRS must verify this return before credit.'));
            $this->scan = '';
            $this->dispatch('focus-scan');
