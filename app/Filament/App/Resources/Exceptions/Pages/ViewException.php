...
class ViewException extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            ActionGroup::make([
                ...
                $this->makeResolveHeaderAction(),
                $this->makeCloseHeaderAction(),
            ])
                ->label('More')
    ...
    private function quarantineActionGroup(): ActionGroup
    {
    ...
    private function makeResolveHeaderAction(): Action
    {
                ...
                ->schema([
                    Select::make('root_cause_id')
                        ...
                        ->default(function (): ?int {
                            ...
                            $code = ExceptionCorrectionProfile::forCase($this->getRecord())->suggestedRootCauseCode();

                            if ($code === null || $code === '') {
                                return null;
                            }

                            $id = ExceptionRootCause::query()->where('code', $code)->value('id');
    ...
    private function makeCloseHeaderAction(): Action
    {
        return RegulatoryCompliance::apply(
            Action::make('close')
                ->label('Close')
