    ...
    public static function definitions(): array
    {
        return [
            ...
            'vrs' => [
                ...
                'in_tracepharma' => [
                    'VRS verification runs at receiving and dispense-check with full audit trail.',
                    'PMS dispense-check APIs block fills when verification fails or serial state is unknown.',
            ...
            'gtin-sgtin' => [
                ...
                'in_tracepharma' => [
                    ...
                    'VRS and dispense-check validate GTIN+serial against tenant verification state.',
                    'Serialization feature covers L3 serial provisioning and outbound EPCIS commission events.',
                ],
            ...
            'epcis-2-0' => [
                'slug' => 'epcis-2-0',
                'title' => 'EPCIS 2.0',
                'meta_description' => 'EPCIS 2.0 and CBV 2.0 for US DSCSA—JSON-LD events, GS1 Digital Link, and what changed from EPCIS 1.2.',
                'summary' => 'Current GS1 event standard (JSON and Digital Link)',
                'definition' => [
                    ...
                    'US DSCSA interoperability increasingly expects EPCIS 2.0-capable systems for partner exchange. Legacy EPCIS 1.2 XML may still appear during transition.',
                ...
                'in_tracepharma' => [
                    'EPCIS repository configured for EPCIS/CBV 2.0 with GS1 Digital Link EPC format.',
                    'Inbound capture accepts partner EPCIS 2.0 JSON and normalized legacy XML.',
                    'Outbound generation and query APIs align with 2.0 schema for wholesaler and manufacturer profiles.',
                ],
