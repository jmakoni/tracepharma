...
/**
 * One tenant-scoped lock per EPC so overlapping decommission sets serialize
 * on shared units. Sorted acquisition avoids deadlocks.
 */
final class AcquireDecommissionEpcLocks
{
    ...
    {
        return 'decommission-epc:'.$tenantId.':'.$epcId;
    }
